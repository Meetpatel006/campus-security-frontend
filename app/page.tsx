// app/page.tsx
// Server component: redirect to /dashboard if authenticated, else show landing with login/signup links.
...
export default async function HomePage() {
    ...
    return (
      <main className="min-h-dvh bg-black text-white flex items-center justify-center">
        <div className="max-w-xl text-center px-6">
          <h1 className="text-3xl font-bold tracking-tight text-balance">Campus Safety — Anomaly Monitor</h1>
          <p className="mt-4 text-white/80">Welcome back, {user.email}. Proceed to your dashboard.</p>
          <div className="mt-6">
            <Link
              href="/dashboard"
              className="inline-block bg-white text-black px-6 py-3 rounded-lg font-medium hover:bg-white/90 transition-all"
            >
              Go to Dashboard
            </Link>
          </div>
  ...
  return (
    <main className="min-h-dvh bg-black text-white">
      ...
      <section className="px-6 py-20 lg:py-32">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link 
              href="/signup" 
              className="bg-white text-black px-8 py-4 rounded-lg font-medium hover:bg-white/90 transition-all text-lg"
            >
              Start Free Trial
            </Link>
            <Link 
              href="/login" 
              className="border border-white/20 px-8 py-4 rounded-lg font-medium hover:bg-white/5 transition-all text-lg"
            >
              Sign In
            </Link>
          </div>
      ...
      {/* Features Section */}
      <section className="px-6 py-20 bg-gray-900/20">
